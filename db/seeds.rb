...
50.times do |n|
  job = Job.new(number_of_staffs: rand(1..20),
    type_of_work: rand(2),
    position: rand(5),
    min_salary: rand(1000000..4000000),
    max_salary: rand(4500000..50000000),
    candidate_experience: rand(10),
    due_date: Faker::Date.between(from: "2021-06-01", to: "2022-09-25"),
